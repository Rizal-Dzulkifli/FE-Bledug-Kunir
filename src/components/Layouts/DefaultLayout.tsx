...
import { toggleSidebar, toggleRTL, toggleTheme, toggleLocale, toggleMenu, toggleLayout, toggleAnimation, toggleNavbar, toggleSemidark } from '../../store/themeConfigSlice';
