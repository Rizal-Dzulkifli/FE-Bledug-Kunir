...
// Tipe data untuk Supplier (menggunakan struktur kontak baru)
type Supplier = {
    id_kontak: number;
    nama: string;
    alamat: string;
...
const MasterDataSupplier = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Master Data Supplier'));
        fetchSupplierList();
    }, []);
    ...
    const [initialRecords, setInitialRecords] = useState<Supplier[]>([]);
    ...
    const fetchSupplierList = async () => {
        ...
        try {
            ...
            const response = await fetch(buildApiUrl('kontaks/suppliers'), {
            ...
            setInitialRecords(supplierData); // Simpan data asli
        } catch (error) {
            console.error('Kesalahan saat mengambil data supplier:', error);
            Swal.fire('Kesalahan', 'Tidak dapat mengambil data supplier', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    useEffect(() => {
        ...
        if (tableRef.current) {
            ...
            setTimeout(() => {
                const searchWrapper = document.getElementById('supplier-search-wrapper');
    ...
    const saveItem = async () => {
        ...
        if (params.id_kontak) {
            ...
            try {
                ...
                console.error('Kesalahan saat menambahkan supplier:', error);
                showMessage('Gagal menambahkan data', 'error');
            }
        }

        setAddModal(false);
        setParams({ id_kontak: 0, nama: '', alamat: '', no_telp: '', role: 'supplier' });
    };

    const editItem = (item: Supplier | null) => {
        if (item) {
            setParams({
    ...
    return (
        <div className="space-y-6">
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
                ...
                <span className="ltr:mr-3 rtl:ml-3">Dokumentasi: Master Data Supplier untuk mengelola informasi kontak supplier dengan validasi nomor telepon otomatis</span>
            </div>
            <div className="flex justify-between items-center mb-5">
                ...
                <div id="supplier-search-wrapper" className="relative">
                    <input
                        type="text"
                ...
                <div className="overflow-x-auto">
                    <div className="table-responsive mb-5">
                        {loading ? (
                            ...
                            <table ref={tableRef} id="supplierTable" className="table-striped w-full">
                                <thead>
                                    <tr>
                                        <th className="px-6 py-3 border-b-2 font-semibold text-black dark:text-white whitespace-nowrap">Nama Supplier</th>
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.id_kontak ? 'Ubah Supplier' : 'Tambah Supplier'}
                                    </div>
                                    <div className="p-5">
                                        <form>
                                            <div className="mb-5">
...
export default MasterDataSupplier;
